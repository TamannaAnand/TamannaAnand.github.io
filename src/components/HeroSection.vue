    ...
    >
      ...
      >
        <div class="lg:py-6">
          <div class="text-center lg:text-left mx-auto max-w-xl">
            ...
            >
              Hi, I'm
              <span
                class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-[#F64668]"
                >Tamanna</span
              >
            </h1>
          </div>
          ...
          >
            Detail-oriented and organized individual with a background in
            scientific research and a passion for solving complex problems.
            Experienced in team collaboration and communication, I am currently
            advancing my full-stack development skills at NSCC, focusing on
            innovative, user focused solutions. Excited for what’s ahead!
          </p>
          <div
          ...
          >
            ...
            <button
              class="border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max fle justify-center"
            >
              <div
        ...
        <div class="lg:h-full md:flex">
          ...
          >
            <div
              class="absolute z-0 top1/2 -translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#570cac] to-primary blur-2xl"
            ></div>
            <div
              class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 log:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary"
            >
              <img
